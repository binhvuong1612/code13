                ...
                firebase.database().ref("Employees").once('value', function(snapshot) {
                  ...
                  var number_employees=task_array_employees.length;
                      firebase.database().ref("Pet/Dog").once('value', function(snapshot) {
                        ...
                        var number_dog=task_array_dog.length;
                          ...
                          firebase.database().ref("Pet/Cat").once('value', function(snapshot) {
                            ...
                            var number_cat=task_array_cat.length;
                              ...
                              firebase.database().ref("Pet/Another").once('value', function(snapshot) {
                                ...
                                var number_another=task_array_another.length;
                                      
                                      document.getElementById("number_pet").innerHTML= number_dog+number_cat+number_another;
