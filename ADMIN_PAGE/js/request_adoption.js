...
//   }
  ...
  function task_delete_request_adoption(task){
    key = task.getAttribute("data-key");
    var name_adopter = task.childNodes[2].childNodes[1].innerHTML;
    alert(name_adopter);
    task_to_remove = firebase.database().ref("Request_Adoption/" + name_adopter);
